...
-- Carlos(2): Lun/Mie/Vie 09:00-18:00
-- Lucia(7):  Mar/Jue 09:00-18:00, Sab 09:00-13:00
-- ============================================================
...
-- ============================================================
-- 8. CITAS (12)
-- Pasadas: 1-6 (jul 02-11) con flujo completo
-- Hoy: 7 (jul 16) en sala de espera
-- Futuras: 8-12 (jul 17-25) agendadas
-- ============================================================
...
-- ============================================================
-- 9. TRIAJES (6) - para citas pasadas 1-6
-- ============================================================
...
-- ============================================================
-- 10. SALA DE ESPERA (7)
-- Citas 1-6 ya ATENDIDAS, cita 7 HOY en PENDIENTE
-- ============================================================
...
-- ============================================================
-- 11. ATENCIONES CLINICAS (6) - para citas pasadas 1-6
-- ============================================================
...
(3,  1, 2, 'DESPARASITACION', 'Antiparasitario General', '2026-07-02', 'Trimestral', '2026-10-02', 'DES-2026-07', 'Merck',   'Desparasitacion durante chequeo anual','APLICADA',  2, CURRENT_TIMESTAMP),
-- Luna (gato)
...
(6,  2, 2, 'VACUNA',       'FeLV (Leucemia Felina)','2026-07-04', 'Unica',    '2027-07-04', 'FEL-2026-07', 'Zoetis',      'Aplicada en cita de vacunacion anual', 'APLICADA',  2, CURRENT_TIMESTAMP),
-- Rex (perro)
...
(2, 4, 4, 2, 'Parasitosis externa leve',               'Administrar con alimento. No bañar en 24h post-tratamiento.',    'EMITIDA',  2, CURRENT_TIMESTAMP),
